  ...
  internal = rec {
    ...
    crates = {
      ...
      "des" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1bigk1x1kxvnfjn1alr8cc383z1flmj8q7g2pjl2zal8i1s7qkmj";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "hyper-tungstenite" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "15ba9nvk44za3pq3cmnbxvfwcmllm2by1b5pzywqg3j6xjblfbsf";
        authors = [
      ...
      "mio" = rec {
        ...
        version = "0.7.8";
        edition = "2018";
        sha256 = "15fdpv7bz05dgfzi178qzp9z2ynznmpm8d6flag723f991l0s9fw";
        authors = [
          "Carl Lerche <me@carllerche.com>"
      ...
      "once_cell" = rec {
        ...
        version = "1.6.0";
        edition = "2018";
        sha256 = "1pgxiiijjfinivh7jpvv4bjzzkhd513a00z0vf12p0sfyni6glaa";
        authors = [
      ...
      "rfbproxy" = rec {
        ...
        edition = "2021";
        crateBin = [
          { name = "rfbproxy"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "windef" "winerror" "winioctl" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
