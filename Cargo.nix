  ...
  internal = rec {
    ...
    crates = {
      ...
      "paseto" = rec {
        ...
        version = "2.0.1+1.0.3";
        edition = "2018";
        sha256 = "1n7fqdy7zdf5qgcsmn6vsfmz8yis9pga3nn17hg1ahh2g6gjbrx9";
        authors = [
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "easy_tokens_chrono" "openssl" "serde_json" "sodiumoxide" "v1" "v2" ];
      };
      "path-clean" = rec {
